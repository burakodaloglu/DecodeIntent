...
class IntentWedgeSample : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_intent_wedge_sample)
    ...
    inner class MyClickedItemListener : RadioGroup.OnCheckedChangeListener {
